...
export default async function HomePage({
  ...
  return (
    <>
        ...
        <div className="container">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-16 items-center max-w-5xl mx-auto">
            ...
            <div className="space-y-5">
              <p className="font-body text-lg text-ferro/80 leading-relaxed">
                È la <HandHighlight>pietra calda</HandHighlight> sotto i piedi al mattino. 
                Il <strong>profumo del bosco</strong> che entra dalla finestra. 
                Un <HandHighlight>calice di Barolo</HandHighlight> mentre il sole scende dietro le colline.
              </p>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-16 items-center max-w-5xl mx-auto">
            ...
            <div className="lg:order-2 space-y-5">
              <p className="font-body text-lg text-ferro/80 leading-relaxed">
                A <strong>[Nome Casolare]</strong> coltiviamo l'<HandHighlight>arte della lentezza</HandHighlight>. 
                Ogni dettaglio — dalle <strong>lanterne in ferro battuto</strong> ai <strong>fiori di campo</strong> — 
          ...
          <div className="text-center mt-14">
            <Link href={`/${locale}/la-dolce-vita`} className="btn btn-terracotta">
      ...
      {/* Divisore */}
      <div className="h-16 bg-gradient-to-b from-bianco-latte to-crema" />
